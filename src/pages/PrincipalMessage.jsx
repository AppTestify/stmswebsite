            ...
            <div className="lg:col-span-8">
              <div className="mb-6">
                <div className="flex items-center gap-3 mb-4">
                  <p className="text-md font-semibold text-gray-600 italic font-serif">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p className=" leading-5 font-serif font-semibold text-gray-900 pt-2">
             ...
             <div className="lg:col-span-4">
              ...
              <div className="mt-5 text-center">
                <h3 className="text-base md:text-md font-serif text-gray-900 mb-2 font-semibold">
                  SR. PRAFULLA PANNA
                </h3>
