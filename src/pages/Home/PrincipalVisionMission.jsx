      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 flex justify-center">
            <div className="flex flex-col md:flex-row justify-center items-center gap-6 max-w-5xl">
              {/* Vision */}
              <div className="bg-blue-900/80 border-2 border-blue-400 rounded-xl px-6 py-6 shadow-xl hover:shadow-2xl transition-shadow duration-300 w-full md:w-[400px]">
              ...
              {/* Mission */}
              <div className="bg-green-900/80 border-2 border-green-400 rounded-xl px-6 py-6 shadow-xl hover:shadow-2xl transition-shadow duration-300 w-full md:w-[400px]">
                <div className="flex items-center mb-5">
